            ...
            <table id="basic-datatables" class="table table-striped table-hover table-bordered-bd-primary table-head-bg-primary mt-3">
                <thead>
                    <tr class="text-center">
                        ...
                        <th scope="col">Type</th> <!-- Kolom baru untuk Type Berita -->
                ...
                <tbody>
                    ...
                    foreach ($berita as $key => $p) { ?>
                        <tr>
                            ...
                            <td class="text-center"><?= $p['type_berita'] ?></td> <!-- Tampilkan Type Berita -->
                            <td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <textarea name="isi_berita" class="form-control" placeholder="Isi Berita" required><?= $p['isi_berita'] ?></textarea>
                        ...
                        <select name="type_berita" class="form-control">
                            <option value="berita" <?= $p['type_berita'] == 'berita' ? 'selected' : '' ?>>Berita</option>
                            <option value="artikel" <?= $p['type_berita'] == 'artikel' ? 'selected' : '' ?>>Artikel</option>
                            <option value="agenda" <?= $p['type_berita'] == 'agenda' ? 'selected' : '' ?>>Agenda</option>
                            <option value="soprenja" <?= $p['type_berita'] == 'soprenja' ? 'selected' : '' ?>>Soprenja</option>
                        </select>
                    </div>
                </div>
