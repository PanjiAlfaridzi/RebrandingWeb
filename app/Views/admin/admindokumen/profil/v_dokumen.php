<div class="col-sm-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            ?>
            <a href="<?= base_url('index.php/Profil/Input') ?>" type="button" class="btn btn-primary btn-sm">
                ...
                <tbody>
                    ...
                    foreach ($dokumen as $key => $p) { ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning btn-xs" data-bs-toggle="modal" data-bs-target="#edit<?= $p['id_profil'] ?>">
                                    <i class="fa fa-pencil-alt"></i>
                                </button>
                                <button class="btn btn-danger btn-xs" data-bs-toggle="modal" data-bs-target="#delete<?= $p['id_profil'] ?>">
...
<?php foreach ($dokumen as $key => $p) { ?>
    <div class="modal fade" id="edit<?= $p['id_profil'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open_multipart('Profil/UpdateData/' . $p['id_profil'], ['enctype' => 'multipart/form-data']); ?>
    ...
    <div class="modal fade" id="delete<?= $p['id_profil'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <?php echo form_open('Profil/DeleteData/' . $p['id_profil']); ?>
                <div class="modal-body">
