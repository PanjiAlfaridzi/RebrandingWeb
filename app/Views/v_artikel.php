...
<body>
    ...
    <div class="container" data-aos="fade-up">
        <div class="section-title">
            <h2><?= isset($query) ? 'Hasil Pencarian' : 'Artikel' ?></h2>
            <p><?= isset($query) ? 'Pencarian untuk: ' . esc($query) : 'Artikel Terbaru' ?></p>
        </div>
        <div class="row">
            <div class="col-lg-6">
                <div class="row flex-column" data-aos="zoom-in" data-aos-delay="100">
                    <?php if ($berita) : ?>
                        <?php foreach ($berita as $item) : ?>
                            <?php if ($item['type_berita'] == 'artikel') : ?> <!-- Tambahkan pengecekan type_berita -->
