                ...
                <tbody>
                    ...
                    foreach ($dokumen as $key => $p) { ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning btn-xs" data-bs-toggle="modal" data-bs-target="#edit<?= $p['id_dokumen'] ?>">
                                    <i class="fa fa-pencil-alt"></i>
                                </button>
                                <button class="btn btn-danger btn-xs" data-bs-toggle="modal" data-bs-target="#delete<?= $p['id_dokumen'] ?>">
...
<?php foreach ($dokumen as $key => $p) { ?>
    <div class="modal fade" id="edit<?= $p['id_dokumen'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
