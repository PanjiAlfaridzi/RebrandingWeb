...
<body>
    ...
    <div class="container" data-aos="fade-up">
        <div class="section-title">
            <h2><?= isset($query) ? 'Hasil Pencarian' : 'Berita' ?></h2>
            <p><?= isset($query) ? 'Pencarian untuk: ' . esc($query) : 'Berita Terbaru' ?></p>
        </div>
        <div class="row">
            <div class="col-lg-6">
                <div class="row flex-column" data-aos="zoom-in" data-aos-delay="100">
                    <?php if ($berita) : ?>
                        <?php foreach ($berita as $item) : ?>
                            <?php if ($item['type_berita'] == 'berita') : ?> <!-- Tambahkan pengecekan type_berita -->
                ...
                <div class="search-bar" data-aos="zoom-in" data-aos-delay="200">
                    <form action="<?= base_url('artikel/search') ?>" method="get">
                        <div class="input-group">
                            <input type="text" name="query" class="form-control" placeholder="Cari berita..." aria-label="Cari artikel..." value="<?= isset($query) ? esc($query) : '' ?>">
