...
use App\Models\ModelSoprenja;

class Soprenja extends BaseController
{
    protected $ModelSoprenja;
    public function __construct()
    {
        $this->ModelSoprenja = new ModelSoprenja();
    ...
    public function index(): string
    {
        ...
        // Ambil total berita
        $total_berita = $this->ModelSoprenja->countAllResults();

        // Ambil berita yang akan ditampilkan sesuai dengan limit dan offset
        $berita = $this->ModelSoprenja->orderBy('tgl_berita', 'DESC')->findAll($limit, $offset);
    ...
    public function search(): string
    {
        ...
        if ($query) {
            $berita = $this->ModelSoprenja->like('judul_berita', $query)
    ...
    public function Input()
    {
        $data = [
            'judul' => 'Input Berita',
            'page' => 'berita/v_input',
            'berita' => $this->ModelSoprenja->AllData(),
        ];
    ...
    public function InsertData()
    {
        ...
        if ($fileGambar->isValid() && !$fileGambar->hasMoved()) {
            ...
            $this->ModelSoprenja->InsertData($data);
    ...
    public function UpdateData($id_berita)
    {
        ...
        if ($fileGambar && $fileGambar->isValid() && !$fileGambar->hasMoved()) {
            ...
            $beritaLama = $this->ModelSoprenja->find($id_berita); // Pastikan fungsi `find` ada di model Anda
        ...
        $this->ModelSoprenja->UpdateData($data);
    ...
    public function DeleteData($id_berita)
    {
        ...
        $this->ModelSoprenja->DeleteData($data);
        return redirect()->to('Berita');
    }
}
