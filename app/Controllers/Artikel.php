...
class Artikel extends BaseController
{
    ...
    public function index(): string
    {
        ...
        // Ambil total berita
        $total_berita = $this->ModelArtikel->countAllResults();

        // Ambil berita yang akan ditampilkan sesuai dengan limit dan offset
        $berita = $this->ModelArtikel->orderBy('tgl_berita', 'DESC')->findAll($limit, $offset);
    ...
    public function search(): string
    {
        ...
        if ($query) {
            $berita = $this->ModelArtikel->like('judul_berita', $query)
    ...
    public function Input()
    {
        $data = [
            'judul' => 'Input Berita',
            'page' => 'berita/v_input',
            'berita' => $this->ModelArtikel->AllData(),
        ];
    ...
    public function InsertData()
    {
        ...
        if ($fileGambar->isValid() && !$fileGambar->hasMoved()) {
            ...
            $this->ModelArtikel->InsertData($data);
    ...
    public function UpdateData($id_berita)
    {
        ...
        if ($fileGambar && $fileGambar->isValid() && !$fileGambar->hasMoved()) {
            ...
            $beritaLama = $this->ModelArtikel->find($id_berita); // Pastikan fungsi `find` ada di model Anda
        ...
        $this->ModelArtikel->UpdateData($data);
    ...
    public function DeleteData($id_berita)
    {
        ...
        $this->ModelArtikel->DeleteData($data);
        return redirect()->to('Berita');
    }
}
