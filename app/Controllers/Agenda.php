...
class Agenda extends BaseController
{
    ...
    public function index(): string
    {
        ...
        // Ambil total berita
        $total_berita = $this->ModelAgenda->countAllResults();

        // Ambil berita yang akan ditampilkan sesuai dengan limit dan offset
        $berita = $this->ModelAgenda->orderBy('tgl_berita', 'DESC')->findAll($limit, $offset);
    ...
    public function search(): string
    {
        ...
        if ($query) {
            $berita = $this->ModelAgenda->like('judul_berita', $query)
    ...
    public function Input()
    {
        $data = [
            'judul' => 'Input Berita',
            'page' => 'berita/v_input',
            'berita' => $this->ModelAgenda->AllData(),
        ];
    ...
    public function UpdateData($id_berita)
    {
        ...
        if ($fileGambar && $fileGambar->isValid() && !$fileGambar->hasMoved()) {
            ...
            $beritaLama = $this->ModelAgenda->find($id_berita); // Pastikan fungsi `find` ada di model Anda
