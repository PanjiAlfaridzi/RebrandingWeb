...
class Dokumen extends BaseController
{
    ...
    public function Input()
    {
        $data = [
            'judul' => 'Input dokumen',
            'page' => 'admin/admindokumen/dokumen/v_input_dokumen',
            'dokumen' => $this->ModelDokumen->AllData(),
        ];
        return view('v_template_back_end', $data);
    }
    ...
    public function InsertData()
    {
        ...
        if ($fileDokumen->isValid() && !$fileDokumen->hasMoved()) {
            ...
            $folderTujuan = FCPATH . 'image/fdokumen'; // Ganti dengan path folder yang diinginkan
    ...
    public function UpdateData($id_dokumen)
    {
        ...
        if ($fileDokumen && $fileDokumen->isValid() && !$fileDokumen->hasMoved()) {
            ...
            $dokumenLama = $this->ModelDokumen->find($id_dokumen); // Pastikan fungsi `find` ada di model Anda
        ...
        $this->ModelDokumen->UpdateData($data);
